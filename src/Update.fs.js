import { Union } from "./fable_modules/fable-library.4.0.0/Types.js";
import { SortDirection, Model, SortBy$reflection, Coin$reflection } from "./Model.fs.js";
import { int32_type, union_type, string_type, list_type } from "./fable_modules/fable-library.4.0.0/Reflection.js";
import { FSharpResult$2 } from "./fable_modules/fable-library.4.0.0/Choice.js";
import { singleton } from "./fable_modules/fable-library.4.0.0/AsyncBuilder.js";
import { sleep } from "./fable_modules/fable-library.4.0.0/Async.js";
...
import { empty, FSharpSet__Add, FSharpSet__Remove, FSharpSet__Contains } from "./fable_modules/fable-library.4.0.0/Set.js";
import { some } from "./fable_modules/fable-library.4.0.0/Option.js";
...
export function Msg$reflection() {
    return union_type("Update.Msg", [], Msg, () => [[["Item", union_type("Microsoft.FSharp.Core.FSharpResult`2", [list_type(Coin$reflection()), string_type], FSharpResult$2, () => [[["ResultValue", list_type(Coin$reflection())]], [["ErrorValue", string_type]]])]], [["Item", string_type]], [["Item", SortBy$reflection()]], [], [], [], [["Item", string_type]], [], [["Item", int32_type]]]);
}
...
export function fetchCoins() {
    return singleton.Delay(() => singleton.Bind(sleep(900), () => singleton.Bind(Http_get(apiUrl), (_arg_1) => {
        ...
        if (statusCode === 200) {
            const matchValue = fromString(uncurry(2, decoderList), _arg_1[1]);

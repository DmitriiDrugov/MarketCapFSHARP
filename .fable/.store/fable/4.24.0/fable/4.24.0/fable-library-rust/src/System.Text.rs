    ...
    pub mod Text {
        ...
        impl StringBuilder {
            ...
            pub fn Append_Z1FBCCD16(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(ofBoolean(o))
            }
            pub fn Append_244C7CD6(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(ofChar(c))
            }
            pub fn Append_Z510FF069(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(toString(o))
            }
            ...
            pub fn Append_487EF8FB(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(substring2(s, index, count))
            }
            pub fn Append_Z372E4D23(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(fromChars(cs))
            }
            pub fn Append_43A65C09(
                ...
                let __self__ = self;
                __self__.Append_Z721C83C5(toString(sb))
            }
            pub fn AppendLine(self: &Lrc<Self>) -> LrcPtr<System::Text::StringBuilder> {
                let __self__ = self;
                __self__.Append_Z721C83C5(string("\n"))
            }
            pub fn AppendLine_Z721C83C5(
                ...
                let __self__ = self;
                (__self__.Append_Z721C83C5(s)).AppendLine()
            }
            pub fn Clear(self: &Lrc<Self>) -> LrcPtr<System::Text::StringBuilder> {
                fromFluent({
                    let __self__ = self;
                    clear(__self__.buf.clone());
                    __self__.clone()
                })
            }
            pub fn get_Chars_Z524259A4(&self, index: i32) -> char {
                ...
                while if ((i.get().clone()) + 1_i32) < (get_Count(__self__.buf.clone())) {
                    (len.get().clone()) < (index)
                } else {
                    false
                } {
                    i.set((i.get().clone()) + 1_i32);
                    len.set((len.get().clone()) + (length((__self__.buf)[i.get().clone()].clone())))
                }
            ...
            pub fn set_Chars_413E0D0A(&self, index: i32, value: char) {
                ...
                if if if (index) < 0_i32 {
                    ...
                    let pos: i32 = ((len.get().clone()) - (index)) - 1_i32;
                    (__self__.buf).get_mut()[i.get().clone() as usize] = append(
                        (append(
                            (getSlice(
                                (__self__.buf)[i.get().clone()].clone(),
                                Some(0_i32),
                                Some((pos) - 1_i32),
                            )),
                            (ofChar(value)),
            ...
            pub fn get_Length(&self) -> i32 {
                let __self__ = self;
                let len: MutCell<i32> = MutCell::new(0_i32);
                for i in (0_i32..=(get_Count(__self__.buf.clone())) - 1_i32).rev() {
                    len.set((len.get().clone()) + (length((__self__.buf)[i].clone())));
                }
                len.get().clone()
            }
            pub fn Replace_Z766F94C0(
                ...
                fromFluent({
                    ...
                    for i in (0_i32..=(get_Count(__self__.buf.clone())) - 1_i32).rev() {
                        (__self__.buf).get_mut()[i as usize] = replace(
                            (__self__.buf)[i].clone(),
                            oldValue_1.clone(),
                            newValue_1.clone(),
                        );
                    }
            ...
            pub fn Replace_Z384F8060(
                ...
                let __self__ = self;
                let str: string = replace(toString(__self__.clone()), oldValue, newValue);
                (__self__.Clear()).Append_Z721C83C5(str)
            }
            pub fn ToString_(&self) -> string {
                let __self__ = self;
                concat(__self__.buf.clone())
            }
            pub fn ToString_Z37302880(&self, index: i32, count: i32) -> string {
                let __self__ = self;
                substring2(toString(__self__.clone()), index, count)
            }
        }
